   ...
   50 ierr = 5
      ...
      INTEGER   :: i, inc, j, jc, jf, jj, k, k1, k2, k3, k4, kk, ks,  
     2             kspan, kspnn, kt, l, m, max, maxf, maxn, maxp, nn,
     3             nt, num
      REAL(dp)  :: aa, aj, ajm, ajp, ak, akm, akp, bb, bj, bjm, bjp, bk, 
     2             bkm, bkp, c1, c2, c3, c72, cd, rad, radf, s1, s2, s3, 
     3             s72, s120, sd, u, v
