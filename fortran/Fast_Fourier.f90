...
REAL(KIND = 8)  :: at(23), ck(23), bt(23), sk(23)

INTEGER   :: i, inc, j, jc, jf, jj, k, k1, k2, k3, k4, kk, ks, kspan, kspnn,  &
             kt, l, m, max, maxf, maxn, maxp, nn, nt, num
REAL(KIND = 8)  :: aa, aj, ajm, ajp, ak, akm, akp, bb, bj, bjm, bjp, bk, bkm, bkp,  &
