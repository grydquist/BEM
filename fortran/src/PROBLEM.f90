...
!!  ============================
    ...
    DO ic = 1, prob%NCell
            ...
            CASE(0)
                prob%cell(ic)%xmn(1,1) = 1.4D0
                prob%cell(ic)%xmn(2,1) = 1.4D0
                prob%cell(ic)%xmn(3,1) = .45D0
            CASE(1)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(2,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(3,1) = .45D0
            CASE(2)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(2,1) = 1.4D0
                prob%cell(ic)%xmn(3,1) = (.45D0 + info%bvl/4D0)
            CASE(3)
                prob%cell(ic)%xmn(1,1) = 1.4D0
                prob%cell(ic)%xmn(2,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(3,1) = (.45D0 + info%bvl/4D0)
            CASE(4)
                prob%cell(ic)%xmn(1,1) = 1.4D0
                prob%cell(ic)%xmn(2,1) = 1.4D0
                prob%cell(ic)%xmn(3,1) = (.45D0 + info%bvl/2D0)
            CASE(5)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(2,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(3,1) = (.45D0 + info%bvl/2D0)
            CASE(6)
                prob%cell(ic)%xmn(1,1) = 1.4D0
                prob%cell(ic)%xmn(2,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(3,1) = (.45D0 + 3D0*info%bvl/4D0)
            CASE(7)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/2D0)
                prob%cell(ic)%xmn(2,1) = 1.4D0
                prob%cell(ic)%xmn(3,1) = (.45D0 + 3D0*info%bvl/4D0)
            ...
            CASE(9)
                ...
                prob%cell(ic)%xmn(3,1) = (.45D0 + 3D0*info%bvl/4D0)
            CASE(10)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/4D0)
                prob%cell(ic)%xmn(2,1) = 1.4D0
                prob%cell(ic)%xmn(3,1) = (.45D0 + 3D0*info%bvl/4D0)
            CASE(11)
                prob%cell(ic)%xmn(1,1) = (1.4D0 + info%bvl/2D0)
            ...
            prob%cell(ic)%xmn(:,1) = prob%cell(ic)%xmn(:,1)/(ispi*0.5D0)
